...
BEGIN
    -- 1. Create Course
    INSERT INTO courses (title, description, xp_reward, image_url)
    VALUES (
    ...
    VALUES 
        (v_course_id, 'Módulo 1: Introducción a las Redes', 'Conceptos básicos, topologías y componentes.', 1)
    RETURNING id INTO v_module_1_id;

    INSERT INTO modules (course_id, title, description, "order")
    VALUES 
        (v_course_id, 'Módulo 2: El Modelo OSI', 'Análisis detallado de las 7 capas del modelo de referencia OSI.', 2)
    RETURNING id INTO v_module_2_id;

    INSERT INTO modules (course_id, title, description, "order")
    VALUES 
        (v_course_id, 'Módulo 3: Protocolos TCP/IP', 'La suite de protocolos de Internet, direcciones IP y enrutamiento.', 3)
