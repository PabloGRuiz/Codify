...
Estudiantes y desarrolladores que quieran dominar los fundamentos de la computación a bajo nivel, comprender cómo funciona la memoria real del procesador y escribir código ultra eficiente.$SUMMARY$,
  ...
  VALUES (
    ...
    'quiz',
    75,
    $THEORY$# Estructura de un Programa en C++
...
- **`std::endl`**: Inserta un salto de línea (`\n`) y vacía el búfer de salida (*flush*).$THEORY$,
  ...
  VALUES (
    ...
    'quiz',
    75,
    $THEORY$# Tipos de Datos Primitivos en C++
...
```$THEORY$,
  ...
  VALUES (
    ...
    'quiz',
    75,
    $THEORY$# Estructuras de Control en C++
...
```$THEORY$,
  ...
  VALUES (
    ...
    'quiz',
    100,
    $THEORY$# Gestión de Memoria Dinámica: Stack vs Heap
...
```$THEORY$,
  ...
  VALUES (
    ...
    'quiz',
    125,
    $THEORY$# Clases y Encapsulamiento en C++
...
```$THEORY$,
  ...
  VALUES (
    ...
    'quiz',
    125,
    $THEORY$# Constructores, Destructores y RAII
...
- Esto garantiza que **nunca haya fugas de recursos**, incluso si ocurren excepciones en el código.$THEORY$,
  ...
  VALUES (
    ...
    'quiz',
    125,
    $THEORY$# Herencia y Polimorfismo en C++
...
- **`override`**: Palabra clave que verifica en tiempo de compilación que realmente estás sobrescribiendo un método virtual de la clase padre.$THEORY$,
  ...
  VALUES (
    ...
    'quiz',
    125,
    $THEORY$# La Standard Template Library (STL)
