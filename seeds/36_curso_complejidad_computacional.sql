    ...
    $JSON$[
      {
        "id": "q1",
        "type": "input",
        "question": "Considera el siguiente código:\n\ndef calcular(n):\n    x = 10\n    y = 20\n    total = x + y\n    for i in range(n):\n        total = total + 5\n    return total\n\nSi cada línea elemental dentro del bucle suma 1 operación por iteración y las 3 asignaciones iniciales más el return suman 4 operaciones constantes, ¿cuántas operaciones elementales exactas ejecuta la función para n = 100?",
